...
const esTranslations: Translations = {
  ...
  "hero.subtitle":
    "Desarrollador Full Stack y hacker ético. Apasionado por la tecnología, la seguridad, cloud y los sistemas complejos.",
  "hero.viewProjects": "Ver proyectos",

  // About Section
  "about.title": "Sobre mí",
  "about.description":
    "Soy un desarrollador apasionado por crear soluciones innovadoras y seguras.",
  ...
  "about.architecture":
    "y estrategias de arquitectura limpia en proyectos tanto personales como profesionales.",
  ...
  "about.development":
    "del desarrollo. Busco siempre comprender cómo cada capa —desde la infraestructura hasta la interfaz— puede fortalecerse para ofrecer software confiable y de alto rendimiento.",
  "about.current": "Actualmente me encuentro expandiendo mis conocimientos en",
  "about.expanding":
    "infraestructura cloud, automatización y metodologías de seguridad ofensiva",
  "about.applying":
    ", aplicando estos principios al desarrollo de aplicaciones modernas y resilientes.",
  "about.badgesTitle": "Verificaciones",
  "about.badgesDescription":
...
const enTranslations: Translations = {
  ...
  "hero.subtitle":
    "Full Stack Developer and ethical hacker. Passionate about technology, security, cloud and complex systems.",
  "hero.viewProjects": "View projects",

  // About Section
  "about.title": "About me",
  "about.description":
    "I'm a developer passionate about creating innovative and secure solutions.",
  ...
  "about.experience":
    "I have experience working with modern environments based on",
  "about.technologies": "React, Angular, .NET and Python",
  "about.practices": ", integrating",
  "about.devsecops": "DevSecOps",
  "about.architecture":
    "practices and clean architecture strategies in both personal and professional projects.",
  ...
  "about.development":
    "of development. I always seek to understand how each layer —from infrastructure to interface— can be strengthened to deliver reliable and high-performance software.",
  "about.current": "I'm currently expanding my knowledge in",
  "about.expanding":
    "cloud infrastructure, automation and offensive security methodologies",
  "about.applying":
    ", applying these principles to the development of modern and resilient applications.",
  "about.badgesTitle": "Verifications",
  "about.badgesDescription": "Public recognitions on cybersecurity platforms.",
  "about.badgesNote":
